<template>
  <div>
    ...
    <div class="text-left">
      <div>
        <b-table striped hover :items="items" :fields="fields">
          <template #cell(actions)="row">
            <b-button size="sm" @click="removeItem(row)" variant="danger" class="mb-2 mr-sm-2 mb-sm-0">
              <b-icon icon="trash" aria-hidden="true"></b-icon>
            </b-button>
            <b-button size="sm" @click="moveItemUp(row)" variant="success" class="mb-2 mr-sm-2 mb-sm-0">
              <b-icon icon="caret-up" aria-hidden="true"></b-icon>
            </b-button>
            <b-button size="sm" @click="moveItemDown(row)" variant="success" class="mb-2 mr-sm-2 mb-sm-0">
      ...
      <div>
        <b-form inline>
          <label class="mb-2 mr-sm-2 mb-sm-0" for="inline-new-url">Ethereum 1 node URL (e. g. infura.io):</label>
          <b-form-input
            id="input-new-url"
            v-model="newUrl"
          ...
          ></b-form-input>
          <b-button size="sm" @click="addItem" variant="primary" class="mb-2 mr-sm-2 mb-sm-0">
...
export default {
  ...
  data() {
    ...
    return {
      items: defaultItems,
      fields: ['url', 'actions'],
      newUrl: "https://" + this.model.network + ".infura.io:443/v3/put-your-infura-id-here",
    }
  },
  watch: {
    'model.network': function(n, o) {
