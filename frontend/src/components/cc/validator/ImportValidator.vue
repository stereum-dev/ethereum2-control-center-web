<template>
  <div id="app" @dragover.prevent @drop.prevent>
    <div
      class="container mt-3 pt-3"
      @dragover="fileDragIn"
      @drop="handleFileDrop"
    >
      <b-form-group
        label="Add your validator keys here:"
        label-for="input-1"
        label-size="m"
      >
      ...
      <ul>
        ...
        >
          ...
          <b-button
            variant="primary"
            style="height: 20px; padding: 0 4px; margin-left: 5px"
